...
class MainActivity : AppCompatActivity() {
    ...
    private fun inputDummySongs() {
        ...
        songDB.SongDao().insert(
            Song("뱃노래", "AKMU(악뮤)", "귓가에 넘치는 바다\n눈을 감고 느낀다",  R.drawable.img_album_sailing, 138, "chantey_akmu", 1, false, 0, 0, false)
        )

        songDB.SongDao().insert(
            Song("물 만난 물고기", "AKMU(악뮤)", "한바탕 휩쓸고 간 폭풍의 잔해 속에\n언제 그랬냐는 듯 잔잔한 파도",  R.drawable.img_album_sailing, 246, "fish_with_water_akmu", 2, false, 0, 0, false)
        )
        ...
        songDB.SongDao().insert(
            Song("달", "AKMU(악뮤)", "유난히 밝은 달\n거대한 원형 속에 보이네 너의 미소", R.drawable.img_album_sailing, 242, "moon_akmu", 4, false, 0, 0, false)
        )
    ...
    private fun changeSong(offset : Int) {
